...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类管理</strong> / <small>/分类修改</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-id">ID</th><th class="table-title">名称</th><th>父级</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
           <tr>
          <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form id="form1" name="form1" action="__URL__/save?id=<?php echo ($vo["id"]); ?>" method="post" >
                  <td><?php echo ($vo["id"]); ?></td>
                   <td><input id="title" name="title" type="text" value="<?php echo ($vo["title"]); ?>" /></td>
                  <td><div class="am-form-group">
                      ...
                      <div class="am-u-sm-9">
                          <select name="fid" data-am-selected="{btnSize: 'sm'}">
                            <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo1["id"]); ?>"><?php echo ($vo1["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                      </div>
                    </div></td>
