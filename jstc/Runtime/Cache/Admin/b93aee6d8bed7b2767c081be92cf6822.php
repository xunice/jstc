...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">产品管理</strong> / <small>所有产品</small></div>
    </div>
    ...
    <ul class="am-avg-sm-2 am-avg-md-4 am-avg-lg-6 am-margin gallery-list">
      <?php if(is_array($racks)): $i = 0; $__LIST__ = $racks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
        <a href="#">
         ...
         <div class="gallery-desc"><?php echo ($vo["price"]); ?></div>
        </a>
